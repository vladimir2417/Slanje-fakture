...
namespace SlanjeFakture
{
    public class PodaciONama
    {
        public void praviPodatkeONama(Document dokument)
        {
            ...
            PdfPCell cell1 = new PdfPCell(new Phrase("www.sudo-per.co.rs", f_10_normal));
            PdfPCell cell2 = new PdfPCell(new Phrase("Bulevar Kralja Aleksandra 321", f_10_normal));
            PdfPCell cell3 = new PdfPCell(new Phrase("PIB: 105501835", f_10_normal));
            PdfPCell cell4 = new PdfPCell(new Phrase("M.B.: 62192208", f_10_normal));
